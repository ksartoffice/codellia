...
export function ElementPanel({ api }: ElementPanelProps) {
  ...
  if (!isVisible) {
    return (
      <div className="cd-settingsSection">
        <div className="cd-settingsSectionTitle">{__( 'Elements', 'cazeart-live-code-editor')}</div>
        <div className="cd-settingsHelp">
          {__( 'Select an element in the preview to edit its content and attributes.', 'cazeart-live-code-editor')}
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="cd-settingsSection">
      ...
      {hasText ? (
        <div className="cd-formGroup">
          <label className="cd-formLabel" htmlFor={fieldId}>
            {__( 'Text', 'cazeart-live-code-editor')}
          </label>
          <textarea
            id={fieldId}
      ...
      <div className="cd-formGroup">
        <div className="cd-formLabel">{__( 'Attributes', 'cazeart-live-code-editor')}</div>
        <div className="cd-settingsScriptList">
          {attributes.map((attr, index) => (
            <div className="cd-settingsScriptRow" key={`attr-${index}`}>
              <input
                ...
                placeholder={__( 'Attribute name', 'cazeart-live-code-editor')}
                value={attr.name}
              ...
              <input
                ...
                placeholder={__( 'Value', 'cazeart-live-code-editor')}
                value={attr.value}
              ...
              <button
                ...
                aria-label={__( 'Remove attribute', 'cazeart-live-code-editor')}
              >
          ...
          >
            {__( 'Add attribute', 'cazeart-live-code-editor')}
          </button>
        </div>
      </div>
    </div>
